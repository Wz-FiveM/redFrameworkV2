...
function _Client.getSkin()
    return (_Client.Player.skin)
end

function _Client.loadSkin(skinTable)
    local playerPed = PlayerPedId()
    _Client.Player.default = skinTable
...
function _Client.saveSkin()
    TriggerServerEvent("skin:save", _Client.Player.default)
end

function _Client.changerSkinKey(key, value)
    _Client.Player.default[key] = value
end